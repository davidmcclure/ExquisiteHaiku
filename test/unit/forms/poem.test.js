...
describe('Poem Form', function() {
  ...
  describe('slug', function() {
    ...
    it('should be unique relative to user\'s poems when user is passed');

    it('should be unique relative to all admin users\' poems when user is not passed');

    it('should not be a reserved root-level slug when user is not passed');
